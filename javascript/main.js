...
document.getElementById('output2').innerText = (prediction.dataSync()[1]*100).toFixed(2);
...
document.getElementById('output3').innerText = (prediction.dataSync()[2]*100).toFixed(2);
...
document.getElementById('output4').innerText = (prediction.dataSync()[3]*100).toFixed(2);
...
document.getElementById('output5').innerText = (prediction.dataSync()[4]*100).toFixed(2);
...
document.getElementById('output6').innerText = (prediction.dataSync()[5]*100).toFixed(2);
